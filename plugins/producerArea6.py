...
logger = logging.getLogger("ProducerArea6")
...
class ProducerArea6:
    def __init__(self):
        ...
        self.locationMonitor16 = "290 Holden Ave, Orlando, FL 32839"
        self.locationMonitor17 = "5529 Hansel Ave, Orlando, FL 32809"
        self.locationMonitor18 = "531 Kenmore Cir, Orlando, FL 32839"
    ...
    def produceDataMonitor16(self, **context):
        self.produce_data(16, self.locationMonitor16)

    def produceDataMonitor17(self, **context):
        self.produce_data(17, self.locationMonitor17)

    def produceDataMonitor18(self, **context):
        self.produce_data(18, self.locationMonitor18)

def produceDataMonitor16(**context):
    ProducerArea6().produceDataMonitor16(**context)


def produceDataMonitor17(**context):
    ProducerArea6().produceDataMonitor17(**context)


def produceDataMonitor18(**context):
    ProducerArea6().produceDataMonitor17(**context)
...
if __name__ == "__main__":
    fake = ProducerArea6()
    for i in range(10):
        print(fake.generateMonitorData(1, "Area 6"))