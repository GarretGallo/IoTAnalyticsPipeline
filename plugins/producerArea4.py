...
logger = logging.getLogger("ProducerArea4")
...
class ProducerArea4:
    def __init__(self):
        ...
        self.locationMonitor10 = "1250 N Alafaya Trail, Orlando, FL 32828"
        self.locationMonitor11 = "304 Palmetto St, Orlando, FL 32824"
        self.locationMonitor12 = "300 Tradeport Dr, Orlando, FL 32824"
    ...
    def produceDataMonitor10(self, **context):
        self.produce_data(10, self.locationMonitor10)

    def produceDataMonitor11(self, **context):
        self.produce_data(11, self.locationMonitor11)

    def produceDataMonitor12(self, **context):
        self.produce_data(12, self.locationMonitor12)

def produceDataMonitor10(**context):
    ProducerArea4().produceDataMonitor10(**context)


def produceDataMonitor11(**context):
    ProducerArea4().produceDataMonitor11(**context)


def produceDataMonitor12(**context):
    ProducerArea4().produceDataMonitor12(**context)

#Test
"""if __name__ == "__main__":
    fake = ProducerArea4()
    for i in range(10):
        print(fake.generateMonitorData(1, "Area 4"))"""