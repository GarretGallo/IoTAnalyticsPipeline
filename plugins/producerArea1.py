...
logger = logging.getLogger("ProducerArea1")
...
class ProducerArea1:
    def __init__(self):
        ...
        self.locationMonitor1 = "6378 Edge O Grove Cir, Orlando, FL 32819"
        self.locationMonitor2 = "6125 St Ives Blvd, Orlando, FL 32819"
        self.locationMonitor3 = "6301 Parson Brown Dr, Orlando, FL 32819"
    ...
    def produceDataMonitor1(self, **context):
        self.produce_data(1, self.locationMonitor1)

    def produceDataMonitor2(self, **context):
        self.produce_data(2, self.locationMonitor2)

    def produceDataMonitor3(self, **context):
        self.produce_data(3, self.locationMonitor3)

def produceDataMonitor1(**context):
    ProducerArea1().produceDataMonitor1(**context)


def produceDataMonitor2(**context):
    ProducerArea1().produceDataMonitor2(**context)


def produceDataMonitor3(**context):
    ProducerArea1().produceDataMonitor3(**context)

#Test
if __name__ == "__main__":
    fake = ProducerArea1()
    for i in range(10):
        print(fake.generateMonitorData(1, "Area 1"))