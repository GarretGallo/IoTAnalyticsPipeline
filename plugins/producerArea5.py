...
logger = logging.getLogger("ProducerArea5")
...
class ProducerArea5:
    def __init__(self):
        ...
        self.locationMonitor13 = "7501 W Colonial Dr, Orlando, FL 32818"
        self.locationMonitor14 = "6651 Old Winter Garden Rd, Orlando, FL 32835"
        self.locationMonitor15 = "6234 W Colonial Dr, Orlando, FL 32808"
    ...
    def produceDataMonitor13(self, **context):
        self.produce_data(13, self.locationMonitor13)

    def produceDataMonitor14(self, **context):
        self.produce_data(14, self.locationMonitor14)

    def produceDataMonitor15(self, **context):
        self.produce_data(15, self.locationMonitor15)

def produceDataMonitor13(**context):
    ProducerArea5().produceDataMonitor13(**context)


def produceDataMonitor14(**context):
    ProducerArea5().produceDataMonitor14(**context)


def produceDataMonitor15(**context):
    ProducerArea5().produceDataMonitor15(**context)

#Test
if __name__ == "__main__":
    fake = ProducerArea5()
    for i in range(10):
        print(fake.generateMonitorData(1, "Area 5"))