...
logger = logging.getLogger("ProducerArea7")
...
class ProducerArea7:
    def __init__(self):
        ...
        self.locationMonitor19 = "520 Lake Como Cir, Orlando, FL 32803"
        self.locationMonitor20 = "2320 E Robinson St, Orlando, FL 32803"
        self.locationMonitor21 = "1501 Noble Pl, Orlando, FL 32801"
    ...
    def produceDataMonitor19(self, **context):
        self.produce_data(19, self.locationMonitor19)

    def produceDataMonitor20(self, **context):
        self.produce_data(20, self.locationMonitor20)

    def produceDataMonitor21(self, **context):
        self.produce_data(21, self.locationMonitor21)

def produceDataMonitor19(**context):
    ProducerArea7().produceDataMonitor19(**context)


def produceDataMonitor20(**context):
    ProducerArea7().produceDataMonitor20(**context)


def produceDataMonitor21(**context):
    ProducerArea7().produceDataMonitor21(**context)

#Test
if __name__ == "__main__":
    fake = ProducerArea7()
    for i in range(10):
        print(fake.generateMonitorData(1, "Area 7"))