...
logger = logging.getLogger("ProducerArea3")
...
class ProducerArea3:
    def __init__(self):
        ...
        self.locationMonitor7 = "1891 4th St, Orlando, FL 32824"
        self.locationMonitor8 = "304 Palmetto St, Orlando, FL 32824"
        self.locationMonitor9 = "300 Tradeport Dr, Orlando, FL 32824"
    ...
    def produceDataMonitor7(self, **context):
        self.produce_data(7, self.locationMonitor7)

    def produceDataMonitor8(self, **context):
        self.produce_data(8, self.locationMonitor8)

    def produceDataMonitor9(self, **context):
        self.produce_data(9, self.locationMonitor9)

def produceDataMonitor7(**context):
    ProducerArea3().produceDataMonitor7(**context)


def produceDataMonitor8(**context):
    ProducerArea3().produceDataMonitor8(**context)


def produceDataMonitor9(**context):
    ProducerArea3().produceDataMonitor9(**context)

#Test
"""if __name__ == "__main__":
    fake = ProducerArea3()
    for i in range(10):
        print(fake.generateMonitorData(1, "Area 3"))"""